...
mixin _$Marca {
  ...
  String? get paisOrigen => throw _privateConstructorUsedError;
...
abstract class $MarcaCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String nombre, String? paisOrigen, bool activa});
}
    ...
    return _then(_value.copyWith(
      ...
      nombre: null == nombre
          ...
          : nombre // ignore: cast_nullable_to_non_nullable
              as String,
      paisOrigen: freezed == paisOrigen
          ? _value.paisOrigen
          : paisOrigen // ignore: cast_nullable_to_non_nullable
              as String?,
      activa: null == activa
          ? _value.activa
...
abstract class _$$MarcaImplCopyWith<$Res> implements $MarcaCopyWith<$Res> {
  factory _$$MarcaImplCopyWith(
          _$MarcaImpl value, $Res Function(_$MarcaImpl) then) =
...
class __$$MarcaImplCopyWithImpl<$Res>
  ...
  __$$MarcaImplCopyWithImpl(
      _$MarcaImpl _value, $Res Function(_$MarcaImpl) _then)
      : super(_value, _then);
...
class _$MarcaImpl implements _Marca {
  ...
  @override
  String toString() {
    return 'Marca(id: $id, nombre: $nombre, paisOrigen: $paisOrigen, activa: $activa)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.paisOrigen, paisOrigen) ||
                other.paisOrigen == paisOrigen) &&
            (identical(other.activa, activa) || other.activa == activa));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, nombre, paisOrigen, activa);
